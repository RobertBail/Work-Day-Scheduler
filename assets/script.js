...
var userInput9 = document.getElementById('hour9').value.replace(/(\r\n|\n|\r)/gm," ");
...
var userInput10 = document.getElementById('hour10').value.replace(/(\r\n|\n|\r)/gm," ");
...
var userInput11 = document.getElementById('hour11').value.replace(/(\r\n|\n|\r)/gm," ");
...
var userInput12 = document.getElementById('hour12').value.replace(/(\r\n|\n|\r)/gm," ");
...
var userInput13 = document.getElementById('hour13').value.replace(/(\r\n|\n|\r)/gm," ");
...
var userInput14 = document.getElementById('hour14').value.replace(/(\r\n|\n|\r)/gm," ");
...
var userInput15 = document.getElementById('hour15').value.replace(/(\r\n|\n|\r)/gm," ");
...
var userInput16 = document.getElementById('hour16').value.replace(/(\r\n|\n|\r)/gm," ");
...
var userInput17 = document.getElementById('hour17').value.replace(/(\r\n|\n|\r)/gm," ");
